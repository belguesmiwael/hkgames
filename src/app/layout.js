...
export const metadata = {
  title: 'HK Games Slime Store — Le Slime N°1 de Tunisie',
  description: 'Slimes artisanaux, unicolores, bicolores et Buddies. Livraison partout en Tunisie. Paiement à la livraison.',
